# RbfVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RbfVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RbfVpnSDK(...) and RbfVpnSDK.test(...) become
#      RbfVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "rbfvpn_sdk"
_SDK_CLASS = "RbfVpnSDK"
