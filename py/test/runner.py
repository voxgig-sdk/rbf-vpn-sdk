...
class RbfVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RbfVpnTestRunner.getenv("RBFVPN_TEST_LIVE")
        override = RbfVpnTestRunner.getenv("RBFVPN_TEST_OVERRIDE")
        ...
        explain = RbfVpnTestRunner.getenv("RBFVPN_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["RBFVPN_TEST_EXPLAIN"] = explain
