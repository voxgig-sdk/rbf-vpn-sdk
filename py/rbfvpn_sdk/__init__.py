...
from rbfvpn_sdk.utility import register

# Load features
from rbfvpn_sdk.feature.base_feature import RbfVpnBaseFeature
from rbfvpn_sdk.features import _has_feature, _make_feature
...
class RbfVpnSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RbfVpnUtility()
        self._utility = utility

        from rbfvpn_sdk.config import shared_config
    ...
    def get_utility(self):
        return RbfVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RbfVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Subscription(self, data=None) -> "SubscriptionEntity":
        ...
        from rbfvpn_sdk.entity.subscription_entity import SubscriptionEntity
        return SubscriptionEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RbfVpnSDK":
        if sdkopts is None:
            sdkopts = {}
