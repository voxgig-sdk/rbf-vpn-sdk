...
from rbfvpn_sdk.core.control import RbfVpnControl
...
from rbfvpn_sdk.core.helpers import get_ctx_prop, to_map
...
class RbfVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, RbfVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RbfVpnError(code, msg, self)
