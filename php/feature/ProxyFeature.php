...
class RbfVpnProxyFeature extends RbfVpnBaseFeature
{
    ...
    public function init(RbfVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RbfVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
