...
class RbfVpnNetsimFeature extends RbfVpnBaseFeature
{
    ...
    private function _simulate(RbfVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RbfVpnContext $ctx, array $applied): void
    {
        $client = $this->client;
