...
// RbfVpn SDK clienttrack feature
...
class RbfVpnClienttrackFeature extends RbfVpnBaseFeature
{
    ...
    public function PostConstruct(RbfVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RbfVpn-SDK';
