...
class RbfVpnTimeoutFeature extends RbfVpnBaseFeature
{
    ...
    private function _with_timeout(RbfVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RbfVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
