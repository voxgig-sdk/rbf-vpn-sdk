...
// RbfVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RbfVpnTestFeature extends RbfVpnBaseFeature
{
    ...
    public function init(RbfVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RbfVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RbfVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RbfVpnContext $ctx, $op, $args): array
    {
