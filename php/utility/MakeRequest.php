...
// RbfVpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RbfVpnMakeRequest
{
    public static function call(RbfVpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RbfVpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RbfVpnResponse($fetched);
        } else {
