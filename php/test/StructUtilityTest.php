...
// RbfVpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RbfVpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RbfVpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(RbfVpnOmni::structfix($val, Struct::undef()))) {
