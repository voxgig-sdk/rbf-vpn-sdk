...
{
    private static function utility(): RbfVpnUtility
    {
        return new RbfVpnUtility();
    }
    ...
    private static function ctx(array $over = []): RbfVpnContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RbfVpnContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RbfVpnOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RbfVpnError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RbfVpnOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RbfVpnMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RbfVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RbfVpnMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RbfVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RbfVpnMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RbfVpnSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RbfVpnMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RbfVpnResponse([]),
            'result' => new RbfVpnResult([]),
        ]);
        [, $err] = RbfVpnMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RbfVpnSpec(['step' => 's']),
            'response' => new RbfVpnResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RbfVpnResult([]),
        ]);
        [, $err] = RbfVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RbfVpnSpec(['step' => 's']),
            'response' => new RbfVpnResponse(self::resp(200, ['v' => 1])),
            'result' => new RbfVpnResult([]),
        ]);
        [, $err] = RbfVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RbfVpnSpec(['step' => 's']),
            'response' => new RbfVpnResponse(self::resp(200, ['v' => 2])),
            'result' => new RbfVpnResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RbfVpnMakeResponse::call($ctx);
    ...
    {
        $preset = new RbfVpnResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RbfVpnSpec([]),
            'response' => new RbfVpnResponse([]),
            'result' => new RbfVpnResult([]),
        ...
        [$got, $err] = RbfVpnMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RbfVpnResult([])]);
        [, $err] = RbfVpnMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RbfVpnSpec([]), 'result' => null]);
        [, $err] = RbfVpnMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RbfVpnSpec(['step' => 's']),
            'result' => new RbfVpnResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RbfVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RbfVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RbfVpnSpec(['step' => 's']),
            'result' => new RbfVpnResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RbfVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RbfVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RbfVpnResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RbfVpnSpec([]),
            'result' => new RbfVpnResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RbfVpnMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RbfVpnMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RbfVpnError('boom', 'boom');
        $utility->fetcher = function (RbfVpnContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RbfVpnSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RbfVpnMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RbfVpnContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RbfVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RbfVpnResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RbfVpnContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RbfVpnSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RbfVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RbfVpnResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RbfVpnSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RbfVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RbfVpnMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RbfVpnMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RbfVpnResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RbfVpnDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RbfVpnResult(['ok' => false])]);
        $this->expectException(RbfVpnError::class);
        RbfVpnDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RbfVpnResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RbfVpnMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RbfVpnBaseFeature();
        $b = new RbfVpnBaseFeature();
        RbfVpnFeatureAdd::call($ctx, $a);
        RbfVpnFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RbfVpnBaseFeature
    {
        $f = new RbfVpnBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RbfVpnFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?RbfVpnSpec $spec): RbfVpnContext
    {
    ...
    private static function auth_bags(): RbfVpnSpec
    {
        return new RbfVpnSpec(['headers' => [], 'query' => []]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RbfVpnPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RbfVpnResponse(['headers' => null]),
            'result' => new RbfVpnResult([]),
        ]);
        RbfVpnResultHeaders::call($ctx);
