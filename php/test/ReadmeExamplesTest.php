...
// RbfVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RbfVpnSDK::test)
...
{
    private const SDK_CLASS = 'RbfVpnSDK';
    ...
    private const SDK_BASE = 'rbfvpn_sdk';
