# RbfVpn PHP SDK Reference

Complete API reference for the RbfVpn PHP SDK.
...
#### `RbfVpnSDK::test($testopts = null, $sdkopts = null)`
...
```php
$result = $client->Subscription()->load();
```
