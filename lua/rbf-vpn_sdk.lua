...
RbfVpnSDK._make_feature = _make_feature


function RbfVpnSDK.new(options)
  local self = setmetatable({}, RbfVpnSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function RbfVpnSDK:options_map()
...
function RbfVpnSDK:get_utility()
  return Utility.copy(self._utility)
end


function RbfVpnSDK:get_root_ctx()
  return self._rootctx
end


function RbfVpnSDK:prepare(fetchargs)
...
function RbfVpnSDK:direct(fetchargs)
...
-- by passing it.
function RbfVpnSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function RbfVpnSDK:graphql(query, variables, ctrl)
...
function RbfVpnSDK:Subscription(data)
...
function RbfVpnSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = RbfVpnSDK.new(sdkopts)
  sdk.mode = "test"
