...
class RbfVpnCacheFeature extends RbfVpnBaseFeature
{
    ...
    private function _through(RbfVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
