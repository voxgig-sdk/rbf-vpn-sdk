...
class RbfVpnStreamingFeature extends RbfVpnBaseFeature
{
    ...
    private function _iterate(RbfVpnResult $result): \Generator
    {
    ...
    private function _streamable(RbfVpnContext $ctx): bool
    {
