...
class RbfVpnRbacFeature extends RbfVpnBaseFeature
{
    ...
    private function _required(RbfVpnContext $ctx): ?string
    {
    ...
    private function _reject(RbfVpnContext $ctx, string $required): void
    {
    ...
    private function _track(RbfVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
