...
class RbfVpnRatelimitFeature extends RbfVpnBaseFeature
{
    ...
    private function _acquire(RbfVpnContext $ctx): void
    {
    ...
    private function _track(RbfVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
