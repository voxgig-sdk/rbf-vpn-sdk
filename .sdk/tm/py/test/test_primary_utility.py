...
from projectname_sdk import RbfVpnSDK
from projectname_sdk.core.spec import RbfVpnSpec
from projectname_sdk.core.result import RbfVpnResult
from projectname_sdk.core.response import RbfVpnResponse
from projectname_sdk.core.operation import RbfVpnOperation
from projectname_sdk.core.error import RbfVpnError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import RbfVpnBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = RbfVpnSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = RbfVpnSDK.test(None, None)
        ...
        class TestInitFeature(RbfVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RbfVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RbfVpnSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RbfVpnSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RbfVpnSDK.test(None, setup_opts)
