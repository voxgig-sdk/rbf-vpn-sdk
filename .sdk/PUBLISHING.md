...
|---|---|---|
| `ts/` | @voxgig-sdk/rbf-vpn-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/rbf-vpn-sdk \
      --repository voxgig-sdk/rbf-vpn-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/rbf-vpn-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/rbf-vpn-sdk --id=<id>` removes one.
