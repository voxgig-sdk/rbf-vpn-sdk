...
func registerSDKWords(r *eng.Registry, client *sdk.RbfVpnSDK) {
...
func runOp(client *sdk.RbfVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
