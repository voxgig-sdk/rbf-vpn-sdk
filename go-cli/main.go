// Command RbfVpn-cli is a CLI + REPL for the RbfVpn SDK,
...
const prompt = "rbf-vpn"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "subscription"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      RBF_VPN_APIKEY (api key), RBF_VPN_BASE (base url override)")
