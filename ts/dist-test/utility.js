...
function envOverride(m) {
    if ('TRUE' === process.env.RBF_VPN_TEST_LIVE ||
        'TRUE' === process.env.RBF_VPN_TEST_OVERRIDE) {
    ...
    m.RBF_VPN_TEST_EXPLAIN = process.env.RBF_VPN_TEST_EXPLAIN || m.RBF_VPN_TEST_EXPLAIN;
    return m;
}
