...
function liveScenariosActive() { return false && process.env.RBF_VPN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RbfVpnSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RBF_VPN_TEST_SUBSCRIPTION_ENTID'];
    ...
    const client = new __1.RbfVpnSDK({
        base: 'http://localhost:8080',
