...
func TestSubscriptionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set RBFVPN_TEST_SUBSCRIPTION_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func subscriptionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("RBFVPN_TEST_SUBSCRIPTION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["RBFVPN_TEST_SUBSCRIPTION_ENTID"])
