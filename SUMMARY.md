...
Results: Successful response with demo subscription details.
...
| --- | --- | --- | --- |
| Subscription | `load` | `GET /api/demo` | See reference |

## Connect to the API

- RBF VPN API Server: `https://rbf1.info`
...
- `rbf-vpn_list`: List records for an entity. No active entity supports this operation.
- `rbf-vpn_load`: Load one record for an entity. Supported entities: `subscription`.
