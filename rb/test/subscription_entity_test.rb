...
class SubscriptionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set RBFVPN_TEST_SUBSCRIPTION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def subscription_basic_setup(extra)
  ...
  entid_env_raw = ENV["RBFVPN_TEST_SUBSCRIPTION_ENTID"]
