...
RBF VPN API client, generated from the OpenAPI spec.

This API provides temporary access to services on rbf1.info, allowing developers to interact programmatically with the RBF network.

Learn more about RBF VPN API at [github.com/l0v3m0n3y/rbfvpn](https://github.com/l0v3m0n3y/rbfvpn).

This is an unofficial SDK for the RBF VPN public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Subscription — that you
...
```go
client := sdk.Test()
result, err := client.Subscription(nil).Load(
    nil, nil,
)
```
...
| Python | `voxgig-sdk-rbf-vpn-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rbf-vpn-sdk/tags) |
| PHP | `voxgig-sdk/rbf-vpn-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rbf-vpn-sdk/tags) |
| Golang | `github.com/voxgig-sdk/rbf-vpn-sdk/go` | `go get github.com/voxgig-sdk/rbf-vpn-sdk/go@latest` |
| Ruby | `voxgig-sdk-rbf-vpn-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rbf-vpn-sdk/tags) |
| Lua | `voxgig-sdk-rbf-vpn-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/rbf-vpn-sdk/tags) |
...
// Load subscription data (returns a Subscription)
const subscription = await client.Subscription().load()
console.log(subscription)
```
...
```bash
cd go-mcp && go build -o rbf-vpn-mcp .
```
...
```json
{
  "mcpServers": {
    "rbf-vpn": {
      "command": "/abs/path/to/rbf-vpn-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Subscription** | The Subscription entity (load). | `/api/demo` |
...
# Load a specific subscription (returns the record, raises on error)
subscription = client.Subscription().load()
print(subscription)
```
...
```go
import sdk "github.com/voxgig-sdk/rbf-vpn-sdk/go"
...
Generated from the RBF VPN API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
